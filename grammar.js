...
module.exports = grammar(Python, {
  ...
  rules: {
    ...
    typed_parameter: $ => prec(PREC.typed_parameter, choice(
      seq(
        field('type', $.c_type),
        choice(
    ...
    sizeof_expression: $ => prec(PREC.new, seq(
      'sizeof',
      '(',
      $.c_type,
      ')',
